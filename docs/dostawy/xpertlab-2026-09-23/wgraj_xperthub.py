#!/usr/bin/env python3
"""Wgrywa pliki 1.0 z XpertLab do Storage XpertHuba (bucket ebooks, nowy podfolder v1.0-xpertlab,
bez nadpisywania) i przepina file_path/epub_path we wszystkich produktach obu ksiazek.
Klucze czytane z XpertHub/.env.local. Backup produktow: backup-produkty-xperthub-przed.json.
...
SRC = pathlib.Path.home() / "Downloads/xpertlab-2026-09-23"
KSIAZKI = {  # stary file_path -> (nowy katalog, nazwa pliku)
    "ewa-stachowska/kosci-na-cale-zycie-v1.0.pdf": ("ewa-stachowska/v1.0-xpertlab", "kosci-na-cale-zycie-v1.0"),
    "bozena-muszynska/v1.0-poprawka-1/grzyby-lecznicze-v1.0.pdf": ("bozena-muszynska/v1.0-xpertlab", "grzyby-lecznicze-v1.0"),
}
